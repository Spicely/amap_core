...
SearchBound _$SearchBoundFromJson(Map<String, dynamic> json) => SearchBound(
      ...
      lowerLeft: json['lowerLeft'] == null
          ? null
          : LatLng.fromJson(json['lowerLeft'] as Map<String, dynamic>),
      upperRight: json['upperRight'] == null
          ? null
          : LatLng.fromJson(json['upperRight'] as Map<String, dynamic>),
      isDistanceSort: json['isDistanceSort'] as bool?,
      polyGonList: (json['polyGonList'] as List<dynamic>?)
          ?.map((e) => LatLng.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$SearchBoundToJson(SearchBound instance) =>
    <String, dynamic>{
